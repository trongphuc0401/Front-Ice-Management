...
import { SolutionFeedbackActions } from "../../../../Mentor/Solutions/List/Partials/Actions";

const columnsSolutionsResponded: TableProps<ISolutionFeedbackRespondedEntity>["columns"] =
  [
    {
      fixed: "left",
      width: 100,
...

    {
      ...
      key: "actions",
      render: (_, record) => (
        <SolutionFeedbackActions
          textButtonViewFeedback="Kết quả phản hồi"
          solutionData={record}
        />
      ),
    },
...
export default columnsSolutionsResponded;
