...
import {
  IUpdateProfileChallengeManagerRequest,
...
type IFormSettingProfile = Omit<IUpdateProfileChallengeManagerRequest, "image">;
...
const ChallengeManagerProfileSetting = () => {
...
export default ChallengeManagerProfileSetting;
